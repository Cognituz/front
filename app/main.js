...
angular
  ...
  .service('Location',          require('models/location'))
  ...
  .component('ctzTeacherProfileAddresses',  require('components/teacher/profile/addresses/list/component'))
  .component('ctzTeacherProfileAddressForm',  require('components/teacher/profile/addresses/form/component'))
